...
/**
 *  我把段头的信息省略了  只加了一个 单个section全选按钮状态  且只放在每个section中第一个row中；（偷懒了）
 */
...
@interface ShoppingCartViewController ()<UITableViewDelegate,UITableViewDataSource,MGSwipeTableCellDelegate,ShoppingSelectedDelegate,SelectedSectionDelegate,BottomViewDelegate>
{
